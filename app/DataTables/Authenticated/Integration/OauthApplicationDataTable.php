...
class OauthApplicationDataTable extends DataTable
{
  /**
  ...
  public function dataTable(QueryBuilder $query): EloquentDataTable
  {
    return (new EloquentDataTable($query))
        ->editColumn('name', function (OauthApplication $data) {
          return view('pages.authenticated.integration.oauth.table.columns._name', compact('data'));
        })
        ->addColumn('action', function (OauthApplication $data) {
          $options = [
   ...
   */
  public function query(OauthApplication $model): QueryBuilder
  {
